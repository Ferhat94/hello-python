...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 17:53:56 2019
...
semi_annual_raise = float(input("Enter the semi-annual raise of your salary as a deciaml: "))
...
while(current_saving <= portion_down_payment):
    ...
    month = month + 1
    if(month % 6 == 0):
        saved_money = saved_money + saved_money*semi_annual_raise
